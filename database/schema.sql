...
CREATE TABLE IF NOT EXISTS teams (
  ...
  CONSTRAINT fk_team_supervisor FOREIGN KEY (supervisor_user_id) REFERENCES users(id) ON DELETE SET NULL
);
...
-- Graduation batches (Đợt tốt nghiệp)
...
CREATE TABLE IF NOT EXISTS milestones (
  ...
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  CONSTRAINT fk_milestone_batch FOREIGN KEY (graduation_batch_id) REFERENCES graduation_batches(id) ON DELETE SET NULL
);
